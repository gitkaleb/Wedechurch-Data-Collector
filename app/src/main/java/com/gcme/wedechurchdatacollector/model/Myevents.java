...
public class Myevents extends SugarRecord {
    ...
    public Myevents(String id, String nameevent, String eventtime, String eventdate, String eventcategory, String eventimageurl,
                    String description, String eventlocation, String eventlongitude, String eventlatitude, String eventchurch,
                    String eventcontact , String eventstartdate, String eventenddate) {
        this.mId = id;
